	...
	<form class="row g-3">
		<div class="col-auto"> <!-- select -->
			<select name="kind" class="form-select"
				...
				<option value="kind1">productName</option>
				<option value="kind2">productContents</option>
				<option value="kind3">productJumsu</option>
			</select>
		</div>
	...
	<div>
		<nav aria-label="Page navigation example">
			<ul class="pagination">
				...
				<li class="page-item"><a class="page-link" href="./list?page=${pager.startNum-1}&search=${pager.search}&kind=${pager.kind}"
